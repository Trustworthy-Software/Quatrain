...
class Quatrain:
    ...
    def train_model(self, ):
        ...
        quatrain_model.fit([x_train_q, x_train_a], y_train, callbacks=callback, validation_split=0.2, batch_size=128,
                             epochs=10, )
    ...
    def predict(self, b_vector, p_vector):
        ...
        y_pred_prob = self.predict_model([x_test_q, x_test_a])[:, 0]
