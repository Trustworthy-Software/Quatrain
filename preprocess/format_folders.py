...
def copy_file(path_patch):
    benchmarks = os.listdir(path_patch)
    for benchmark in benchmarks:
        path_benchmark = os.path.join(path_patch, benchmark)
                        ...
                        for patch in patches:
                            ...
                            for root, dirs, files in os.walk(path_single_patch):
                                for file in files:
                                    ...
                                    new_folder = new_folder.replace('PatchNaturalnessYe', 'PatchNaturalnessYe2')
...
# path_patch = '/Users/haoye.tian/Documents/ISSTA2022withText/PatchNaturalnessYe'
